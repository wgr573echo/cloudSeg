...
_C.DATASET = CN()
_C.DATASET.ROOT = ''
_C.DATASET.DATASET = 'remote'
_C.DATASET.NUM_CLASSES = 2
_C.DATASET.TRAIN_SET = 'list/remote/forest/train_L7_ch1.lst'
_C.DATASET.EXTRA_TRAIN_SET = ''
_C.DATASET.TEST_SET = 'list/remote/forest/val_L7_ch1.lst'

# training
_C.TRAIN = CN()

_C.TRAIN.IMAGE_SIZE = [512,512]#[1024, 512]  # width * height
_C.TRAIN.BASE_SIZE = 512#2048
...
_C.TEST.IMAGE_SIZE = [512,512]#[2048, 1024]  # width * height
_C.TEST.BASE_SIZE = 512#2048
